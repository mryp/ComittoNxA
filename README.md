...
### [Ver1.65A20C5 (2021/12/14)](https://github.com/yuma211-lab/ComittoNxA/releases/tag/1.65A20C5)
...
TODO（2021/11/12）：PDFとEPUBのテキストデータの読み込み対応 / TIFF対応 / OSのアップデートによるファイルリストまわりの不具合の確認 / SDKおよびサードライブラリのアップデート
